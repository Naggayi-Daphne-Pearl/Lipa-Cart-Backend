...
const QUESTIONS: Question[] = [
  // Rider — Safe rides, happy customers
  {
    ...
    option_a: 'Ride faster so the food does not get cold',
  ...
  },
  {
    ...
    option_a: 'Leave the food at the gate and mark "Delivered"',
    option_b: 'Call the customer using the app',
    option_c: 'Take the food back to the shop',
    correct_option: 'b',
  ...
  },
  {
    ...
    option_a: 'Before I leave the shop',
    option_b: "When I am near the customer's house",
    option_c: 'After the customer has the food in their hand',
    correct_option: 'c',
  ...
  },
  {
    role: 'rider',
    order: 5,
    prompt: 'The food bag is open or leaking when you pick it up. What do you do?',
    option_a: 'Deliver it anyway, it is not my problem',
    option_b: 'Tell the shopper before you leave',
    option_c: 'Throw the food away',
    correct_option: 'b',
    explanation:
  ...
  },
  {
    role: 'shopper',
    order: 3,
    prompt: 'The matoke the customer ordered is finished in the market. What do you do?',
